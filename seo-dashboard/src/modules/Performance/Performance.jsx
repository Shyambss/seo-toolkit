...
const Performance = () => {
  ...
  const fetchReports = async () => {
    try {
      const res = await axios.get(`${API}/api/performance/reports`);
      setReports(res.data);
    } catch (err) {
  ...
  const fetchTrackedSite = async () => {
    try {
      const res = await axios.get(`${API}/api/performance/tracked`);
  ...
  const handleAnalyze = async (url) => {
    ...
    setLoading(true);
    try {
      const response = await axios.get(`${API}/api/performance/analyze`, {
        params: { url },
      });
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`${API}/api/performance/reports/${id}`);
      fetchReports();
          ...
          onClick={async () => {
            ...
            try {
              if (trackedSite.frequency) {
                ...
                await axios.post(`${API}/api/performance/tracked`, {
